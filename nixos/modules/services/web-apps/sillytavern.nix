  ...
  options = {
    services.sillytavern = {
      ...
      extensionDir = lib.mkOption {
        ...
        default = null;
        description = ''
          Directory where SillyTavern extensions are stored.
        '';
      };
    };
  };
  ...
  config = lib.mkIf cfg.enable {
    systemd.services.sillytavern = {
      ...
      serviceConfig = {
        ...
        BindPaths = lib.optional (cfg.extensionDir != null) [
          "${cfg.extensionDir}:${pkgs.sillytavern}/opt/sillytavern/public/scripts/extensions/third-party"
        ];
      };
    };
    ...
    systemd.tmpfiles.settings.sillytavern."/var/lib/sillytavern/data".d = {
      mode = "0700";
